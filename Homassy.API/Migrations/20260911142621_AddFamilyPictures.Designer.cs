...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homassy.API.Entities.Activity.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Homassy.API.Entities.Family.ExternalCalendarReminderDispatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.Family.FamilyChatMessageReference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.Family.FamilyJoinRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.Family.FamilyPicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.ShoppingList.ShoppingList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.User.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Homassy.API.Entities.Family.ExternalCalendarReminderDispatch", b =>
                {
                    b.HasOne("Homassy.API.Entities.Family.FamilyExternalCalendar", null)
                        .WithMany()
                        .HasForeignKey("ExternalCalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Homassy.API.Entities.User.User", null)
                        .WithMany()
