  ...
  <div>
    ...
    <template v-else>
      ...
      <EmptyState
        ...
        :illustration="hasActiveQuery ? 'search' : 'shoppingList'"
        :title="hasActiveQuery ? $t('profile.shoppingLists.noResults') : $t('profile.shoppingLists.noLists')"
        :description="hasActiveQuery ? $t('profile.shoppingLists.tryDifferentSearch') : $t('profile.shoppingLists.addFirstList')"
        :action-label="hasActiveQuery ? $t('common.filters.clear') : $t('profile.shoppingLists.addList')"
