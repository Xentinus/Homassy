...
namespace Homassy.Data.Extensions;
...
public static class SerilogExtensions
{
    ...
    /// <summary>
    /// The production environment name, spelled out rather than taken from
    /// <c>Microsoft.Extensions.Hosting.Environments</c>. This file is compiled into
    /// <c>Homassy.Data</c>, which deliberately references no hosting or ASP.NET Core
    /// assemblies (#91); the constant it used from there is this string.
    /// </summary>
    ...
    private static bool IsSqlLoggingEnabled(string? environmentName)
    {
        ...
        return !string.Equals(environmentName, ProductionEnvironmentName, StringComparison.OrdinalIgnoreCase);
    }
}
